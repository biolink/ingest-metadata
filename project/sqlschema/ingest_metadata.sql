...
-- # Class: "IngestMetadata" Description: "Represents a IngestMetadata"
...
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: description Description: A human-readable description for a thing
--     * Slot: IngestMetadataCollection_id Description: Autocreated FK slot
-- # Class: "IngestMetadataCollection" Description: "A holder for IngestMetadata objects"
--     * Slot: id Description: 
...
CREATE TABLE "IngestMetadataCollection" (
	id INTEGER NOT NULL, 
	PRIMARY KEY (id)
);
CREATE TABLE "IngestMetadata" (
	...
	name TEXT, 
	description TEXT, 
	"IngestMetadataCollection_id" INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY("IngestMetadataCollection_id") REFERENCES "IngestMetadataCollection" (id)
);